...
mygame = Target(
    script = "my_shooing_game.py",
    dest_base = "PeaceKeepingAircraft",
    icon_resources = [(1, r"pico2d.ico")],
    other_resources = [(RT_MANIFEST, 1, (manifest_template % dict(prog="my_shooting_game", level="asInvoker")).encode("utf-8"))]
    )
